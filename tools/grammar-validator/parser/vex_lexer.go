...
func vexlexerLexerInit() {
	...
	staticData.serializedATN = []int32{
		...
		21, 0, 23, 9, 1, 0, 6, 1, 0, 34, 34, 2, 0, 65, 90, 97, 122, 1, 0, 48, 57,
		...
		3, 13, 6, 0, 34, 37, 3, 15, 7, 0, 35, 37, 5, 46, 0, 0, 36, 33, 1, 0, 0,
		0, 36, 34, 1, 0, 0, 0, 36, 35, 1, 0, 0, 0, 37, 38, 1, 0, 0, 0, 38, 36,
		1, 0, 0, 0, 38, 39, 1, 0, 0, 0, 39, 10, 1, 0, 0, 0, 40, 46, 5, 34, 0, 0,
		41, 45, 8, 0, 0, 0, 42, 43, 5, 92, 0, 0, 43, 45, 5, 34, 0, 0, 44, 41, 1,
		0, 0, 0, 44, 42, 1, 0, 0, 0, 45, 48, 1, 0, 0, 0, 46, 44, 1, 0, 0, 0, 46,
		47, 1, 0, 0, 0, 47, 49, 1, 0, 0, 0, 48, 46, 1, 0, 0, 0, 49, 50, 5, 34,
		0, 0, 50, 12, 1, 0, 0, 0, 51, 52, 7, 1, 0, 0, 52, 14, 1, 0, 0, 0, 53, 54,
		7, 2, 0, 0, 54, 16, 1, 0, 0, 0, 55, 56, 7, 3, 0, 0, 56, 18, 1, 0, 0, 0,
		57, 58, 7, 4, 0, 0, 58, 20, 1, 0, 0, 0, 59, 63, 5, 59, 0, 0, 60, 62, 8,
		5, 0, 0, 61, 60, 1, 0, 0, 0, 62, 65, 1, 0, 0, 0, 63, 61, 1, 0, 0, 0, 63,
